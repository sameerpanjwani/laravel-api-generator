...
class ScaffoldGeneratorCommand extends BaseCommand
{
    ...
    public function handle()
    {
        ...
        if(strtolower($display_service_creation=="yes")){
            ...
            $this->call("make:crud-display-service",['name'=>$append.$this->commandData->folder_name."\\".$this->commandData->modelName,'--main_table_id'=>$this->commandData->main_table_id,'--primary_key_field_name'=>$this->commandData->model_primary_key,'--folder_name'=>$this->commandData->folder_name]);
